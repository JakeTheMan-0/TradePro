...
public class TradeProConfig {
         ...
         * and loads all values into memory. This method does not update or reset the
         * files.
         */
        public void reload() {
                load();
                ...
                permissionsRequired = config.getBoolean("permissions.required",
                                config.getBoolean("permissionrequired", false));
                sendPermission = config.getString("permissions.send",
                                config.getString("permissionnode", "tradepro.send"));
                ...
                extrasTypeEmpty = MsgUtils.color(config.getString("extras.type.empty",
                                "&ePlease enter your %EXTRA% offer, or type 'cancel'."));
                extrasTypeValid = MsgUtils
                                .color(config.getString("extras.type.valid", "&aClick output slot to submit offer."));
                extrasTypeInvalid = MsgUtils
                                .color(config.getString("extras.type.invalid", "&cInvalid amount entered!"));
                extrasTypeMaximum = MsgUtils
                                .color(config.getString("extras.type.maximum", "&cYou have %BALANCE% %EXTRA%"));

                factionsAllowTradeInEnemyTerritory = config.getBoolean("hooks.factions.allow-trades-in-enemy-territory",
                                false);
                ...
                requestSent = new ConfigMessage(lang, "request.sent",
                                "&6&l(!) &r&6You sent a trade request to &e%PLAYER%");
                ...
                tradingEnabled = new ConfigMessage(lang, "enabled",
                                "&6&l(!) &r&6You &aenabled &6trade requests from other players!");
                tradingDisabled = new ConfigMessage(lang, "disabled",
                                "&6&l(!) &r&6You &cdisabled &6trade requests from other players!");

                errorsCreative = new ConfigMessage(lang, "errors.creative",
                                "&4&l(!) &r&4You can't trade in creative mode!");
                errorsCreativeThem = new ConfigMessage(lang, "errors.creative-them",
                                "&4&l(!) &r&4That player is in creative mode!");
                errorsSameIp = new ConfigMessage(lang, "errors.same-ip",
                                "&4&l(!) &4Players aren't allowed to trade on same IP!");
                errorsBlockedWorld = new ConfigMessage(lang, "errors.blocked-world",
                                "&4&l(!) &r&4You can't trade in this world.");
                ...
                acceptSender = new ConfigMessage(lang, "accept.sender",
                                "&6&l(!) &r&e%PLAYER% &6accepted your trade request");
                acceptReceiver = new ConfigMessage(lang, "accept.receiver",
                                "&6&l(!) &r&6You accepted &e%PLAYER%'s &6trade request");
                ...
                errorsPlayerNotFound = new ConfigMessage(lang, "errors.player-not-found",
                                "&4&l(!) &r&4Could not find specified player");
                errorsSelfTrade = new ConfigMessage(lang, "errors.self-trade",
                                "&4&l(!) &r&4You cannot trade with yourself");
                errorsInvalidUsage = new ConfigMessage(lang, "errors.invalid-usage",
                                "&4&l(!) &r&4Invalid arguments. Usage: %NEWLINE%    &c- /trade <player name>%NEWLINE%    &c- /trade deny");
                errorsBlacklistedItem = new ConfigMessage(lang, "errors.blacklisted-item",
                                "&4&l(!) &r&4You cannot trade that item!");
                errorsTradingDisabled = new ConfigMessage(lang, "errors.trading-disabled",
                                "&4&l(!) &r&4That player has trading toggled off.");
                errorsNoPermsAccept = new ConfigMessage(lang, "errors.no-perms.accept",
                                "&4&l(!) &r&4You do not have permission to trade");
                errorsNoPermsSend = new ConfigMessage(lang, "errors.no-perms.send",
                                "&4&l(!) &r&4You do not have permission to send a trade");
                ...
                forcedTrade = new ConfigMessage(lang, "forced-trade",
                                "&6&l(!) &r&6You've been forced into a trade with &e%PLAYER%");
                theyDenied = new ConfigMessage(lang, "denied.them",
                                "&4&l(!) &r&4Your trade request to &c%PLAYER% &4was denied");
                youDenied = new ConfigMessage(lang, "denied.you",
                                "&4&l(!) &r&4Any recent incoming trade requests have been denied.");
                spectateMessage = new ConfigMessage(lang, "spectate",
                                "&6&l(!) &e%PLAYER1% &6and &e%PLAYER2% &6have started a trade %NEWLINE%&6&l(!) &6Type &e/tradepro spectate %PLAYER1% %PLAYER2% &6to spectate");
                ...
                adminPlayersOnly = new ConfigMessage(lang, "admin.players-only",
                                "&4&l(!) &4This command is for players only.");
                ...
                if (accept.getStack() == null) {
                        ...
                        if (material == null) {
                                Bukkit.getLogger().warning(
                                                "[TradePro] Invalid Material: RED_STAINED_GLASS_PANE. Falling back to PAPER.");
                ...
                if (cancel.getStack() == null) {
                        cancel = new ItemFactory("GREEN_STAINED_GLASS_PANE")
                ...
                if (complete.getStack() == null) {
                        complete = new ItemFactory("GREEN_STAINED_GLASS_PANE")
                ...
                if (cancelled.getStack() == null) {
                        cancelled = new ItemFactory("RED_STAINED_GLASS_PANE")
                ...
                if (theirAccept.getStack() == null) {
                        theirAccept = new ItemFactory("GREEN_STAINED_GLASS_PANE")
                ...
                if (theirCancel.getStack() == null) {
                        theirCancel = new ItemFactory("RED_STAINED_GLASS_PANE")
                ...
                if (separator.getStack() == null) {
                        separator = new ItemFactory("BLACK_STAINED_GLASS_PANE")
                                        .display(" ")
                                        .flag("HIDE_ATTRIBUTES")
                                        .save(gui, "separator");
                }
                ...
                if (placeholder.getStack() == null) {
                        placeholder = new ItemFactory("BLACK_STAINED_GLASS_PANE")
                                        .display(" ")
                                        .flag("HIDE_ATTRIBUTES")
        ...
        public void loadConfig() {
                if (configFile.exists()) {
                        config = loadConfigurationSafe(configFile);
                } else {
                        ...
                        config.set("ranges.blocked-worlds",
                                        Arrays.asList("ThisWorldDoesntExistButItsBlocked",
                        ...
                        config.set("extras.economy.lore",
                                        Arrays.asList("&fClick to edit your offer!", "&fYou have %BALANCE% money."));
                        ...
                        config.set("extras.experience.theirdisplay",
                                        "&aTheir XP offer is &2%AMOUNT% &a(+%LEVELS% levels)");
                        config.set("extras.experience.lore",
                        ...
                        config.set("extras.playerpoints.lore", Arrays.asList("&fClick to edit your offer!",
                                        "&fYou have %BALANCE% player points."));
                        ...
                        config.set("extras.griefprevention.material", "GOLDEN_SHOVEL");
                        config.set("extras.griefprevention.display", "&eYour GriefPrevention offer is &6%AMOUNT%");
                        config.set("extras.griefprevention.theirdisplay",
                                        "&eTheir GriefPrevention offer is &6%AMOUNT%");
                        config.set("extras.griefprevention.lore", Arrays.asList("&fClick to edit your offer!",
                                        "&fYou have %BALANCE% protection blocks."));
                        ...
                        config.set("extras.enjinpoints.lore", Arrays.asList("&fClick to edit your offer!",
                                        "&fYou have %BALANCE% enjin points."));
                        ...
                        config.set("extras.tokenenchant.theirdisplay",
                                        "Their TokenEnchants tokens offer is &6%AMOUNT%");
                        config.set("extras.tokenenchant.lore", Arrays.asList("&fClick to edit your offer!",
                                        "&fYou have %BALANCE% enchant tokens."));
                        ...
                        config.set("extras.tokenmanager.lore",
                                        Arrays.asList("&fClick to edit your offer!", "&fYou have %BALANCE% tokens."));
                        ...
                        config.set("extras.beasttokens.lore",
                                        Arrays.asList("&fClick to edit your offer!", "&fYou have %BALANCE% tokens."));
                        ...
                        config.set("extras.votingplugin.theirdisplay",
        ...
        public void loadLang() {
                if (langFile.exists()) {
                        lang = loadConfigurationSafe(langFile);
                } else {
                        try {
                        ...
                        lang.set("request.received.text",
                                        "&6&l(!) &r&6You received a trade request from &e%PLAYER%%NEWLINE%&6&l(!) &r&6Type &e/trade %PLAYER% &6to begin trading");
                        ...
                        lang.set("errors.within-range.same-world",
                                        "&4&l(!) &r&4You must be within %AMOUNT% blocks of a player to trade with them");
                        lang.set("errors.within-range.cross-world",
                                        "&4&l(!) &r&4You must be within %AMOUNT% blocks of a player%NEWLINE%&4&l(!) &r&4in a different world to trade with them!");
                        lang.set("errors.no-cross-world",
                                        "&4&l(!) &r&4You must be in the same world as a player to trade with them!");
                        ...
                        lang.set("errors.wait-for-expire",
                                        "&4&l(!) &r&4You still have an active trade request%NEWLINE%&4&l(!) &r&4It will expire shortly");
                        ...
                        lang.set("errors.no-perms.receive",
                                        "&4&l(!) &r&4That player does not have permission to accept a trade");
        ...
        public void loadGui() {
                if (guiFile.exists()) {
                        gui = loadConfigurationSafe(guiFile);
                } else {
                        try {
                        ...
                        gui.set("my-slots",
                                        Stream.of(1, 2, 3, 9, 10, 11, 12, 18, 19, 20, 21, 27, 28, 29, 30, 36, 37, 38,
                                                        39, 45, 46, 47, 48)
                                                        .map(i -> Integer.toString(i))
                                                        .collect(Collectors.toList()));
                        gui.set("their-slots",
                                        Stream.of(5, 6, 7, 14, 15, 16, 17, 23, 24, 25, 26, 32, 33, 34, 35, 41, 42, 43,
                                                        44, 50, 51, 52, 53)
                                                        .map(i -> Integer.toString(i))
                                                        .collect(Collectors.toList()));

                        gui.set("my-extra-slots", Arrays.asList("45", "46", "47", "48", "39", "38", "37", "36", "27",
                                        "28", "29", "30"));
                        gui.set("their-extra-slots", Arrays.asList("50", "51", "52", "53", "44", "43", "42", "41", "32",
                                        "33", "34", "35"));
                        ...
                        new ItemFactory("CLOCK")
                                        .display("&4&lForce Trade")
                                        .lore(Arrays.asList("&7Click to force the trade",
                                                        "&7to countdown and accept as", "&7it stands now."))
                                        .flag("HIDE_ATTRIBUTES")
                                        .save(gui, "force.icon");
                        ...
                        new ItemFactory("RED_STAINED_GLASS_PANE")
                                        .display("&aClick to Accept")
                                        .lore(Arrays.asList(
                                                        "&7If either of you change",
                                                        "&7your offers during the countdown,",
                        ...
                        new ItemFactory("GREEN_STAINED_GLASS_PANE")
                                        .display("&cClick to Cancel")
                                        .flag("HIDE_ATTRIBUTES")
                                        .save(gui, "accept.my-cancel");
                        ...
                        new ItemFactory("BLACK_STAINED_GLASS_PANE")
                                        .display(" ")
                                        .flag("HIDE_ATTRIBUTES")
                                        .save(gui, "separator");
        ...
        private YamlConfiguration loadConfigurationSafe(File file) {
                YamlConfiguration config = new YamlConfiguration();
                try {
                        String content = new String(Files.readAllBytes(file.toPath()), StandardCharsets.UTF_8);
                        content = content.replace("==: org.bukkit.inventory.ItemStack",
                                        "legacy_serializer: org.bukkit.inventory.ItemStack");
                        content = content.replace("==: ItemMeta", "legacy_serializer: ItemMeta");
                        config.loadFromString(content);
                } catch (Exception e) {
                        e.printStackTrace();
                        return YamlConfiguration.loadConfiguration(file); // fallback
                }
                return config;
        }
}
